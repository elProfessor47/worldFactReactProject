...
const CountryCard = ({ currCountry }) => {
  ...
  return (
    <li className="flex flex-col justify-center bg-[#2e2e2e] items-center w-65 border border-gray-500 px-5 py-4 rounded-2xl shadow-[1px_1px_5px_2px_#2e2e2e] hover:shadow-[1px_1px_5px_5px_#2e2e2e] duration-300 shadow-gray-500 hover:scale-103 transition-all">
      <div>
        <img
